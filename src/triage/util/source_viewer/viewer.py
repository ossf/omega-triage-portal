...
class SourceViewer:
    ...
    def load_if_needed(self):
        ...
        with tempfile.TemporaryDirectory() as temp_directory:
            res = subprocess.run(["oss-download", "-e", "-x", temp_directory, self.package_url], capture_output=True)
            ...
            logger.debug('Adding %d entries to cache', len(cache_updates[f"sv_{self.package_url}_files"]))
