    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "findings",
                    models.ManyToManyField(related_name="cases", to="triage.Finding"),
                ),
                (
                    "notes",
                    models.ManyToManyField(related_name="cases", to="triage.Note"),
                ),
                (
                    "updated_by",
                    models.ForeignKey(
